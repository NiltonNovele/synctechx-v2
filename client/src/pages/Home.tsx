...
const copy = {
  pt: {
    ...
    hero: { kicker: 'CIBERSEGURANÇA • MOÇAMBIQUE', title: 'Veja o risco antes que ele chegue a si.', body: 'A SyncTechX combina avaliação ofensiva, engenharia defensiva e remediação prática para transformar incerteza digital em decisões claras.', primary: 'Mapear o risco', secondary: 'Conhecer o método' },
  ...
  en: {
    ...
    hero: { kicker: 'CYBERSECURITY • MOZAMBIQUE', title: 'See risk before it finds your business.', body: 'SyncTechX combines offensive assessment, defensive engineering and practical remediation to turn digital uncertainty into clear decisions.', primary: 'Map the risk', secondary: 'Explore the method' },
